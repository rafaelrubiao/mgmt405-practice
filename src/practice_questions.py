...
QUESTIONS += [
{
    "id": "m4i-q1", "module": "M4-I", "theme": "Long-Run Equilibrium in Perfect Competition", "format": "open", "order": 99,
    ...
    "hints": [
        "Long-run equilibrium in perfect competition: each firm earns zero economic profit, so P = min LATC.",
...
{
    "id": "m4i-q4", "module": "M4-I", "theme": "Producer Surplus in Perfect Competition", "format": "open",
...
},
{
    ...
    "ask": "Of the $5 tax, what fraction is borne by buyers? (Express as a decimal, e.g., 0.5.)",
...
},
{
    ...
    "hints": [
        ...
        "Free-market: 240 − 4P = 6P → P* = $24, Q* = 144. At ceiling P=$18: Q_s = 108 (only this much is supplied — the binding constraint), Q_d = 168 (buyers want more). Q_traded = 108.",
...
},
{
    ...
    "hints": [
        "DWL = the triangle between the demand curve and MC, from Q_monopoly to Q_competitive. Area = ½ × (Q_competitive − Q_monopoly) × (P_monopoly − MC).",
        "Q_competitive (where P = MC): 50 − Q = 10 → Q_competitive = 40. Q_monopoly = 20 (from the previous question). P_monopoly = $30, MC = $10.",
        "DWL = ½ × (40 − 20) × ($30 − $10) = ½ × 20 × 20 = $200.",
    ],
    "solution": "Step 1 — Perfect-competition quantity (where P = MC): 50 − Q = 10 → Q_competitive = 40.\nStep 2 — Monopoly quantity (from the previous question): Q_monopoly = 20; P_monopoly = $30.\nStep 3 — DWL is the triangle between demand and MC, from Q_monopoly to Q_competitive:\n          DWL = ½ × (Q_competitive − Q_monopoly) × (P_monopoly − MC)\n              = ½ × (40 − 20) × ($30 − $10)\n              = ½ × 20 × 20\n              = $200.",
},
{
...
QUESTIONS += [
{
    ...
    "solution": "Each firm's reaction function:\n  q_i = (a − MC − q_j) / 2  where a = 120\n      = (90 − q_j) / 2\n      = 45 − q_j/2\n\nSymmetric Nash equilibrium: q₁ = q₂ = q.\n  q = 45 − q/2\n  1.5 q = 45\n  q* = 30 each.\n\nTotal Q = 60. Market P = 120 − 60 = $60. Each firm's profit = (60 − 30) × 30 = $900.\n\n(For comparison: monopoly would set Q=45, P=$75, profit $2,025. Cournot industry profit is $1,800 — less than monopoly but more than the zero profit under perfect competition.)",
},
{
